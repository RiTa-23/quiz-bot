...
const navClass = ({ isActive }: { isActive: boolean }) =>
  `whitespace-nowrap border-b-2 px-3 pb-2 pt-1 text-sm font-bold transition ${
    isActive
    ...
    <div className="min-h-screen bg-paper">
      <header className="border-b-4 border-gold-400 bg-navy-900">
        <div className="mx-auto max-w-4xl px-4">
          {/* 1段目: ロゴと本人まわり。狭い画面でも必ず横1行に収める */}
          <div className="flex items-center gap-3 py-2">
            <span className="whitespace-nowrap font-bold tracking-tight text-paper">
            ...
            <div className="ml-auto flex min-w-0 items-center gap-2 sm:gap-3">
              {me.guilds.length > 0 ? (
                <Select
                  ...
                  className="min-w-0 max-w-28 sm:max-w-48"
                >
                  {me.guilds.map((g) => (
              ...
              <span className="hidden max-w-32 truncate text-sm text-navy-200 sm:inline">
